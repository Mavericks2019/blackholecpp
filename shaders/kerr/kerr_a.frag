...
// Adapted from ShaderToy Buffer A to OpenGL
// https://github.com/baopinshui/NPGS
...
uniform sampler2D iChannel0;   // mouse/keyboard state
uniform sampler2D iChannel1;
uniform sampler2D iChannel2;   // Buffer B (camera state) 
uniform sampler2D iChannel3;   // Buffer A (TAA history)
uniform vec3 iChannelResolution[4];

// =============================================================================
// Rendering parameters (from BufferA)
// =============================================================================
...
void main() {
    ...
    if(iFrame > 0) {
        PrevColor = texelFetch(iHistoryTex, ivec2(FragCoord), 0);
    }
